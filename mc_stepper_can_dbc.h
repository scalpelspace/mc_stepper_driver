...
typedef enum {
  ...
  MC_STEPPER_CAN_DBC_IDX_DATETIME_SET = 5,
  MC_STEPPER_CAN_DBC_IDX_DATETIME_GET = 6,
  MC_STEPPER_CAN_DBC_IDX_DATETIME_GET_RESPONSE = 7,
  MC_STEPPER_CAN_DBC_IDX_VERSION_GET = 8,
  MC_STEPPER_CAN_DBC_IDX_VERSION_GET_RESPONSE = 9,
