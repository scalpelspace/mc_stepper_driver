...
typedef enum {
  ...
  MC_STEPPER_CAN_DBC_IDX_ABSOLUTE_ENCODER = 2,
  MC_STEPPER_CAN_DBC_IDX_COMMAND_STEPPER = 3,
  MC_STEPPER_CAN_DBC_IDX_CONTROLS_DIAGNOSTIC = 4,
  MC_STEPPER_CAN_DBC_IDX_COMMAND_STEPPER_ZERO = 5,
