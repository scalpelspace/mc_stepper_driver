...
typedef enum {
  ...
  MC_STEPPER_CAN_DBC_IDX_DATETIME_SET = 6,
  MC_STEPPER_CAN_DBC_IDX_DATETIME_GET = 7,
  MC_STEPPER_CAN_DBC_IDX_DATETIME_GET_RESPONSE = 8,
  MC_STEPPER_CAN_DBC_IDX_VERSION_GET = 9,
  MC_STEPPER_CAN_DBC_IDX_VERSION_GET_RESPONSE = 10,
